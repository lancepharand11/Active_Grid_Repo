...
def run_kfold_training(X_all, Y_all, Y, k_folds=5, hidden_size=64, num_epochs=1000, learning_rate=1e-3, batch_size=16, device=None):
    if device is None:
    ...
    return (best_overall_weights, best_scaler_x, best_scaler_y,
            ...
            best_overall_rmse, best_norm_rmse_turb_int, best_norm_rmse_L_ux, fold_results)