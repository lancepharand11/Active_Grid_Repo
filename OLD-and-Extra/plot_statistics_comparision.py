...
def plot_statistics_comparision(turb_data, nu=1.5e-5):
    ...
    axs[0].scatter(hearst_ro['Ro'], hearst_ro['Tu'], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[0].scatter(hearst_u['Ro'], hearst_u['Tu'], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[0].scatter(larssen['Ro'][4:], larssen['Tu'][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[1].scatter(hearst_ro['Re_M'], hearst_ro['Tu'], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[1].scatter(hearst_u['Re_M'], hearst_u['Tu'], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[1].scatter(larssen['uinfty'][4:] * 0.21 / nu, larssen['Tu'][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[2].scatter(hearst_ro['Ro'], hearst_ro['L_ux'], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[2].scatter(hearst_u['Ro'], hearst_u['L_ux'], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[2].scatter(larssen['Ro'][4:], larssen['L_ux'][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[3].scatter(hearst_ro['Re_M'], hearst_ro['L_ux'], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[3].scatter(hearst_u['Re_M'], hearst_u['L_ux'], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[3].scatter(larssen['uinfty'][4:] * 0.21 / nu, larssen['L_ux'][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[4].scatter(hearst_ro['Ro'], hearst_ro['u_v'], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[4].scatter(hearst_u['Ro'], hearst_u['u_v'], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[4].scatter(larssen['Ro'][4:], larssen['u_v'][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[5].scatter(hearst_ro['Re_M'], hearst_ro['u_v'], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[5].scatter(hearst_u['Re_M'], hearst_u['u_v'], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[5].scatter(larssen['uinfty'][4:] * 0.21 / nu, larssen['u_v'][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[6].scatter(hearst_ro['Ro'], hearst_ro["Re_lambda"], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[6].scatter(hearst_u['Ro'], hearst_u["Re_lambda"], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[6].scatter(larssen['Ro'][4:], larssen["Re_lambda"][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
    ...
    axs[7].scatter(hearst_ro['Re_M'], hearst_ro["Re_lambda"], c='r', marker=hearst_marker, label=r'Hearst and Lavoie (2015)', linewidths=0.5)
    axs[7].scatter(hearst_u['Re_M'], hearst_u["Re_lambda"], c='r', marker=hearst_marker, label='_nolegend_', linewidths=0.5)
    axs[7].scatter(larssen['uinfty'][4:] * 0.21 / nu, larssen["Re_lambda"][4:], c='b', marker=larssen_marker, label=r'Larssen and Devenport. (2011)', linewidths=0.5)
